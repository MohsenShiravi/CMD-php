...
<body>
    ...
    <section id="container" class="">
        ...
        <header class="header white-bg">
            ...
            <!--logo start-->
            <a href="#" class="logo">کنترل<span>وب </span></a>
            <!--logo end-->
                ...
                <ul class="nav pull-right top-menu">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu extended logout">
                            ...
                            <li><a href="http://127.0.0.1/php/CMS/admin/dashbord.php?m=settings&p=edit"><i class="icon-cog"></i>تنظیمات</a></li>
                            <li><a href="http://localhost:81/php/CMS/contact&p=list"><i class="icon-bell-alt"></i>تماس ها</a></li>
            ...
            <div id="sidebar" class="nav-collapse ">
                ...
                <ul class="sidebar-menu">
                    ...
                    <li class="sub-menu">
                        <a href="javascript:;" class="">
                            <i class="icon-book"></i>
                            <span>مدیریت ویجت 2</span>
                            <span class="arrow"></span>
                        </a>
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=widget2&p=list">لیست ویجت 2</a></li>
                            <li><a class="" href="dashbord.php?m=widget2&p=add">افزودن ویجت جدید</a></li>
                        </ul>
                    </li>
                    <!--widget2 end-->
                ...
                <li class="sub-menu">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul class="sub">
                            <li><a class="" href="dashbord.php?m=settings&p=edit">ویرایش تنظیمات</a></li>
